<?php
    ...
    $tableroRequerido = "RadAudCuentas";   // ← Cambia según el tablero
...
<head>
    ...
    <title>RADICACIÓN Y AUDITORIA DE CUENTAS</title>
...
<body class="hold-transition sidebar-mini layout-fixed" style="background-image: url('../static/img/fondo5.png');background-size: cover;background-repeat: no-repeat; background-position: center;background-attachment: fixed;">
   ...
   <header>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        <div class="row">
            <div class="card border-info">
                ...
                <!--FIN BOTON BACK--> 
                <h1 class="card-title text-center" style="margin:auto;"><b>RADICACIÓN Y AUDITORIA DE CUENTAS</b></h1>
                <div class="card-body">
                                    ...
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-header text-start"style="background-color: #ffffffff;" >
                                                <h6 class="my-0 font-weight-bold">AUDITORIA GLOSAS</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-deck mb-3 d-flex justify-content-start">
                                                <div class="card mb-4 shadow-sm" style="width: 14rem;">
                                                    ...
                                                    <div class="card-body">
                                                        <button type="button" class="btn btn-light" data-toggle="modal" data-target="#modalPowerBI">
                                                            <img src="../static/img/imgRadAudCuentas/RC1.png"
                                                                class="card-img-top"
    ...
    <!------------------------------------------ Modal Power bi Auditoria Glosas  --------------------------------->
        ...
        <div class="modal-dialog modal-xl" style="max-width: 90%;">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#038f03ff; color:white;">
                    <h5 class="modal-title" id="modalPowerBILabel">Tablero Auditoria Glosas</h5>
                ...
                <div class="modal-body p-0">
                    ...
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiNjk5OTcxOWYtZGQyYS00MWVkLTg0NTktNzg3ZDk2NGM4YTA5IiwidCI6ImIxMmQwMGE5LWZjYjMtNDgzNi1iMDk0LWU3ZWNmZDAyM2U5OSIsImMiOjR9"
