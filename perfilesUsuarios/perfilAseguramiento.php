...
<body class="hold-transition sidebar-mini layout-fixed" style="background-image: url('../static/img/fondo5.png');background-size: cover;background-repeat: no-repeat; background-position: center;background-attachment: fixed;">
   ...
   <header>
                                    ...
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-header text-start"style="background-color: #ffffffff;" >
                                                <h6 class="my-0 font-weight-bold">AFILIACION Y LIQUIDACION USUARIOS LMA</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                            ...
                                            <div class="card-deck mb-3 d-flex justify-content-start">
                                                <div class="card mb-4 shadow-sm" style="width: 14rem;">
                                                    <div class="card-header">
                                                        <h6 class="my-0 font-weight-bold">AFILIACION USUARIOS LMA</h6>
                                                    </div>
                                                    <div class="card-body">
                                                        <button type="button" class="btn btn-light" data-toggle="modal" data-target="#modalPowerBI">
                                                            <img src="../static/img/imgAseguramiento/AS1.png"
                                                                class="card-img-top"
    ...
    <!------------------------------------------ Modal Power bi AFILIACION USUARIOS LMA --------------------------------->
        ...
        <div class="modal-dialog modal-xl" style="max-width: 90%;">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#038f03ff; color:white;">
                    <h5 class="modal-title" id="modalPowerBILabel">Tablero AFILIACION USUARIOS LMA</h5>
                ...
                <div class="modal-body p-0">
                    ...
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiZjgwMWJmYWEtNjdlMi00ZGZmLTkwZjUtYzgxMDg3YTFhNmUyIiwidCI6ImIxMmQwMGE5LWZjYjMtNDgzNi1iMDk0LWU3ZWNmZDAyM2U5OSIsImMiOjR9"
