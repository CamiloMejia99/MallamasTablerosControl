                                    ...
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-header text-start"style="background-color: #ffffffff;" >
                                                <h6 class="my-0 font-weight-bold">NOTA TECNICA</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                                ...
                                                <div class="card mb-4 shadow-sm" style="width: 14rem;">
                                                    ...
                                                    <div class="card-body">
                                                        <button type="button" class="btn btn-light" data-toggle="modal" data-target="#modalPowerBI">
                                                            <img src="../static/img/imgSistemas/SI1.png"
                                                                class="card-img-top"
    ...
    <div class="modal fade" id="modalPowerBI" tabindex="-1" aria-labelledby="modalPowerBILabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" style="max-width: 90%;">
            ...
            <div class="modal-header" style="background-color:#038f03ff; color:white;">
                <h5 class="modal-title" id="modalPowerBILabel">Tablero Nota Técnica - Sistemas</h5>
