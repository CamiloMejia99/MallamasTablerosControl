<?php
    ...
    $tableroRequerido = "Contrataciones";   // ← Cambia según el tablero
...
<body class="hold-transition sidebar-mini layout-fixed" style="background-image: url('../static/img/fondo5.png');background-size: cover;background-repeat: no-repeat; background-position: center;background-attachment: fixed;">
   ...
   <header>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        <div class="row">
            <div class="card border-info">
                ...
                <!--FIN BOTON BACK--> 
                <h1 class="card-title text-center" style="margin:auto;"><b>CONTRATACIONES</b></h1>
                <div class="card-body">
                            ...
                            <table>
                                    ...
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-header text-start"style="background-color: #ffffffff;" >
                                                <h6 class="my-0 font-weight-bold">REDES INTEGRALES DE PRESTACIÓN DE SERVICIOS </h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-deck mb-3 d-flex justify-content-start">
                                                <div class="card mb-4 shadow-sm" style="width: 14rem;">
                                                    ...
                                                    <div class="card-body">
                                                        <button type="button" class="btn btn-light" data-toggle="modal" data-target="#modalReInPreSe">
                                                            <img src="../static/img/imgContrataciones/CO1.png"
                                                                class="card-img-top"
                                ...
                                <tr align="center">
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-header text-start"style="background-color: #ffffffff;" >
                                                <h6 class="my-0 font-weight-bold">SUPERVISIÓN DE CONTRATOS </h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-deck mb-3 d-flex justify-content-start">
                                                <div class="card mb-4 shadow-sm" style="width: 14rem;">
                                                    ...
                                                    <div class="card-body">
                                                        <button type="button" class="btn btn-light" data-toggle="modal" data-target="#modalSupContr">
                                                            <img src="../static/img/imgContrataciones/CO2.png"
                                                                class="card-img-top"
                                                                style="width:100px; height:100px; object-fit:contain; display:block; margin:auto;"
                                                                alt="MallamasImg">
                                                        </button>
    ...
    <!------------------------------------------ Modal Power bi Redes Integrales de Prestación de Servicio  --------------------------------->
    <div class="modal fade" id="modalReInPreSe" tabindex="-1" aria-labelledby="modalReInPreSeLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" style="max-width: 90%;">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#038f03ff; color:white;">
                    <h5 class="modal-title" id="modalReInPreSeLabel">Tablero Redes Integrales de Prestación de Servicio</h5>
                ...
                <div class="modal-body p-0">
                    ...
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiN2M1YjdjNDItMDUyZS00OTBjLWIyNDAtMWJiMDEzNGM5YmI2IiwidCI6ImIxMmQwMGE5LWZjYjMtNDgzNi1iMDk0LWU3ZWNmZDAyM2U5OSIsImMiOjR9"
    ...
    <!---------------------------------------------------------------------------------------------> 
    <!------------------------------------------ Modal Power bi Supervisión de Contratos --------------------------------->
    <div class="modal fade" id="modalSupContr" tabindex="-1" aria-labelledby="modalSupContrLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" style="max-width: 90%;">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#038f03ff; color:white;">
                    <h5 class="modal-title" id="modalSupContrLabel">Tablero Supervisión de Contratos </h5>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Cerrar">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body p-0">
                    <div class="iframe-container" style="position:relative; width:100%; padding-bottom:70%; height:0; overflow:hidden;">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiOWI5YjZlYjEtY2ViZS00N2RhLTkzMzAtMTNiNDFiMDIxMGJhIiwidCI6ImIxMmQwMGE5LWZjYjMtNDgzNi1iMDk0LWU3ZWNmZDAyM2U5OSIsImMiOjR9"
                            allowFullScreen="true"
                            style="position:absolute; top:0; left:0; width:100%; height:100%; border:none;">
                    </iframe>
                    </div>
