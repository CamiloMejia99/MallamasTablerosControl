<?php
    ...
    $tableroRequerido = "Contabilidad";   // ← Cambia según el tablero
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        <div class="row">
            <div class="card border-info">
                ...
                <!--FIN BOTON BACK--> 
                <h1 class="card-title text-center" style="margin:auto;"><b>CONTABILIDAD</b></h1>
                <div class="card-body">
                                    ...
                                    <td>
                                        ...
                                        <div class="col">
                                            <div class="card-header text-start"style="background-color: #ffffffff;" >
                                                <h6 class="my-0 font-weight-bold">COSTOS</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                                ...
                                                <div class="card mb-4 shadow-sm" style="width: 14rem;">
                                                    ...
                                                    <div class="card-body">
                                                        <button type="button" class="btn btn-light" data-toggle="modal" data-target="#modalPowerBI">
                                                            <img src="../static/img/imgContabilidad/CO1.png"
                                                                class="card-img-top"
        ...
        <div class="modal-dialog modal-xl" style="max-width: 90%;">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#038f03ff; color:white;">
                    <h5 class="modal-title" id="modalPowerBILabel">Tablero Costos</h5>
                ...
                <div class="modal-body p-0">
                    ...
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiMjQ1ODZhMGItOThhMi00NDA0LWE3OTItMTlmNmYwYTg4ZDNmIiwidCI6ImIxMmQwMGE5LWZjYjMtNDgzNi1iMDk0LWU3ZWNmZDAyM2U5OSIsImMiOjR9"
